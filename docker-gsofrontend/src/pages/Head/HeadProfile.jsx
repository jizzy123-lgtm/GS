...
} from '../../components/HeadSidebar'; // adjust path as needed
...
// ─── Inner component (needs HeadNotificationProvider in tree) ─────────────────
const HeadProfileInner = () => {
  ...
  return (
    <div className="flex flex-col h-screen bg-gray-50">
        ...
        >
          <nav className="py-2">
            {HEAD_MENU_ITEMS.map((item) => (
              ...
              >
                <svg xmlns="http://www.w3.org/2000/svg" className="w-5 h-5 mr-3" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
      ...
      <div className="flex flex-1 overflow-hidden">
        {/* Head Sidebar (has notification badge built-in) */}
        <HeadSidebar
...
// ─── Exported page — wraps inner component with HeadNotificationProvider ──────
const HeadProfile = () => (
  <HeadNotificationProvider>
    <HeadProfileInner />
  </HeadNotificationProvider>

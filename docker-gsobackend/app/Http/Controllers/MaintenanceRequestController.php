...
class MaintenanceRequestController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        // ✅ Fixed: uses whereDoesntHave('feedback') which now correctly maps to maintenance_request_id
    ...
    public function submitFeedback(Request $request, $id)
    {
        ...
        if ($maintenanceRequest->status_id !== 5) {
          return response()->json(['message' => 'You can only submit feedback on requests that are marked as done.'], 400);
        }
        ...
        if ($alreadySubmitted) {
            return response()->json(['message' => 'You have already submitted feedback for this request.'], 400);
        }
        ...
        $request->validate([
            ...
            'office_visited'  => 'nullable|string',
            'service_availed' => 'nullable|string',
            'cc1'             => 'nullable|integer',
            'cc2'             => 'nullable|integer',
            'cc3'             => 'nullable|integer',
            'sqd0'            => 'nullable|integer',
            'sqd1'            => 'nullable|integer',
            'sqd2'            => 'nullable|integer',
            'sqd3'            => 'nullable|integer',
            'sqd4'            => 'nullable|integer',
            'sqd5'            => 'nullable|integer',
            'sqd6'            => 'nullable|integer',
            'sqd7'            => 'nullable|integer',
            'sqd8'            => 'nullable|integer',
        ...
        Feedback::create([
            ...
            'age'                    => $request->age,
            'office_visited'         => $request->office_visited,
        ...
        foreach ($staffUsers as $staff) {
            SystemNotification::create([
                'user_id'      => $staff->id,
                'type'         => 'maintenance_request_feedback_received',
                'message'      => 'A feedback has been submitted by ' . $requesterName . ' for maintenance request #' . $maintenanceRequest->id . '.',
                'is_read'      => false,
                'reference_id' => $maintenanceRequest->id,
            ]);
        }

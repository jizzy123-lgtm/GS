...
import {
  AdminSidebar,
  MENU_ITEMS as ADMIN_MENU_ITEMS,
  AdminNotificationProvider,
} from '../../components/AdminSidebar'; // adjust path as needed
...
// ─── Inner component (needs AdminNotificationProvider in tree) ────────────────
const AdminProfileInner = () => {
  ...
  return (
    <div className="flex flex-col h-screen bg-gray-50">
      ...
      <div className="flex flex-1 overflow-hidden">
        {/* Admin Sidebar (has notification badge built-in) */}
        <AdminSidebar
                      ...
                      <>
                        ...
                        <div className="mb-6">
                          <h1 className="text-2xl font-bold text-center text-gray-900">
                            {formData.requesting_personnel || 'Admin Name'}
                          </h1>
...
// ─── Exported page — wraps inner component with AdminNotificationProvider ─────
const AdminProfile = () => (
  <AdminNotificationProvider>
    <AdminProfileInner />
  </AdminNotificationProvider>

...
class MaintenanceRequestUrgent extends Notification
{
    use Queueable;
    ...
    public function toMail($notifiable)
    {
        return (new MailMessage)
            ->subject('Your Maintenance Request is Marked as Urgent')
            ->greeting('Hello ' . $notifiable->first_name . ',')
            ->line('Your maintenance request has been marked as urgent.')

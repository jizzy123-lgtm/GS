import { useState, useReducer, useEffect, memo, useRef, useCallback } from 'react';
              ...
              <thead>
                <tr className="bg-gray-50">
                  {["Sun", "Mon", "Tue", "Wed", "Thu", "Fri", "Sat"].map((day) => (
                    <th key={day} className="border border-gray-100 p-2 text-sm font-semibold text-gray-700 w-[14.28%]">{day}</th>
                  ))}
                </tr>
              </thead>
              <tbody>{weeks}</tbody>

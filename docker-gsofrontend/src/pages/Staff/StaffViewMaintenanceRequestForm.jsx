              ...
              <div className="bg-white rounded-3xl shadow-xl border border-slate-200 overflow-hidden">
                ...
                <div className="p-8">
                  ...
                  <div className="mt-12 pt-8 border-t-2 border-slate-50 flex flex-wrap gap-4 justify-end">
                    ...
                    {requestDetails.approved_by_2 && !requestDetails.priority_number && (
                      <button 
                    ...
                    {requestDetails.approved_by_2 && requestDetails.priority_number && requestDetails.status !== "Scheduled" && requestDetails.status !== "Completed" && requestDetails.status !== "Done" && (
                      <button 
